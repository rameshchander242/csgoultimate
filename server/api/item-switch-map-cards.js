...
router.get('/item-switch-map-cards', function (req, res) { 
	sequelize.models.userSwitchMapCards.findAll({where:{userId:req.userId, marketStatus:0},
		include:[
			{ model:sequelize.models.switchMapCards, as:"switchMapCardData", 
				include:[
