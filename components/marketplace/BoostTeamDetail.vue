...
export default {
  ...
  methods: {
    ...
    buyItem(){
      this.$props.marketBuy({id: this.cardDetails.id, CardId: this.cardDetails.playerCardId, userCardId: this.cardDetails.userPlayerCardId, price: this.cardDetails.marketValue}, this.cardDetails.cardType)
      this.listDialog = false
    },
    removeItem(){
      this.$props.marketRemove({id: this.cardDetails.id, CardId: this.cardDetails.playerCardId, userCardId: this.cardDetails.userPlayerCardId, price: this.cardDetails.marketValue}, this.cardDetails.cardType)
      this.listDialog_ = false
    },
  }
}
